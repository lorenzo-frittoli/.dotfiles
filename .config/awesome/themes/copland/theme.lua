...
theme.wallpaper                                 = theme.dir .. "/tempwall.jpg"
...
theme.brightness                                = theme.dir .. "/icons/brightness.png"
...
theme.corner_round_radius                       = dpi(10)
...
local shape                                     = function(cr, w, h)
    gears.shape.rounded_rect(cr, w, h,
        theme.corner_round_radius)
end

-- Textclock
--os.setlocale(os.getenv("LANG")) -- to localize the clock
local mytextclock                               = wibox.widget.textclock(
    "<span font='Terminus 5'> </span>%a %Y-%m-%d %H:%M  ")
...
-- Brightness
local brightnessicon = wibox.widget.imagebox(theme.brightness)
...
local brightnessbg = wibox.container.background(batbar, "#474747", gears.shape.rectangle)
local brightnesswidget = wibox.container.margin(batbg, dpi(2), dpi(7), dpi(4), dpi(4))
